...
%Responsible for the maintence and enhancement of IoT embedded systems. Leveraged AWS IoT platforms to ensure cloud-device coherence in unreliable network environments.
